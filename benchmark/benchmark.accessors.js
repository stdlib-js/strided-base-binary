...
*/
function add( z1, z2 ) {
	return new Complex64( real( z1 )+real( z2 ), imag( z1 )+imag( z2 ) );
}
...
function createBenchmark( len ) {
	...
	ybuf = filledarrayBy( len*2, 'float32', discreteUniform( -100, 100 ) );
	y = new Complex64Array( ybuf );

	obuf = filledarray( 0.0, len*2, 'float32' );
	o = new Complex64Array( obuf );
