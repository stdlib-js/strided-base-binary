...
```javascript
binary = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-binary@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-binary@umd/bundle.js"></script>
```
