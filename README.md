...
```javascript
binary = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-binary@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided-base-binary/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/strided-base-binary/actions/workflows/test.yml?query=branch:v0.2.1
